...
glm::mat4 createCameraMatrix()
{
	float time = glutGet(GLUT_ELAPSED_TIME) / 1000.0f - appLoadingTime;
		...
		int index1 = currentSecond % NUM_CAMERA_POINTS;
		int index2 = (index1 + 1) % NUM_CAMERA_POINTS;
		int index3 = (index1 + 2) % NUM_CAMERA_POINTS;
		int index4 = (index1 - 1) % NUM_CAMERA_POINTS;
		glm::vec3 position = catmullRom(cameraKeyPoints[index4], cameraKeyPoints[index1], cameraKeyPoints[index2], cameraKeyPoints[index3], s);

		glm::vec3 tangentVector = glm::normalize(glm::catmullRom(cameraKeyPoints[index4], cameraKeyPoints[index1], cameraKeyPoints[index2], cameraKeyPoints[index3], s + 0.001) - glm::catmullRom(cameraKeyPoints[index4], cameraKeyPoints[index1], cameraKeyPoints[index2], cameraKeyPoints[index3], s - 0.001));
